...
// int/float in c++ takes 4 bytes in the computer's memory, 8 bits make 1 byte. Which means that "int" in c++ takes 32 bits of spaces.
// char in c++ takes 1 byte in the computer's memory (8 bits of space)
// bool in c++ takes 1 byte in the computer's memory (8 bits of space)
// string in c++ takes 24 bytes in the computer's memory (192 bits of space)
// double in c++ takes 8 bytes in the computer's memory (64 bits of space)
